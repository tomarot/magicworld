$(function() {
    ...
    function n(href,id,title) {
		var t = $(this).attr("href")||href,
			a = $(this).data("index")||id,
			i = $.trim($(this).text()),
			n = !0;
		...
		if ($(".J_menuTab").each(function() {
			...
			$("iframe[name='iframe"+a+"']").attr("src",t);
		}
		return !1
//        return false;
	}
    ...
    window.bindMenuEvent = function bindMenuEvent(){
   ...
   // window.bindMenuEvent();
    window.initBindEvent = function initBindEvent(){
        window.bindMenu();
        window.bindMenuEvent();
    }

    window.createTab = function(href,id,title){
            var t = href,
                a = id,
                i = $.trim(title),
                n = !0;
